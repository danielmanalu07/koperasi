  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider<MiniMarketBloc>(
          create: (_) => di.sl<MiniMarketBloc>()..add(GetMiniMarketDataEvent()),
        ),
        BlocProvider<DashboardBloc>(
          create: (_) => di.sl<DashboardBloc>()..add(LoadDashboardEvent()),
        ),
        BlocProvider<AssetBloc>(
          create: (_) => di.sl<AssetBloc>()..add(LoadAssetEvent()),
        ),
        BlocProvider<TransactionBloc>(
          create: (_) => di.sl<TransactionBloc>()..add(LoadTransactionEvent()),
        ),
        BlocProvider<ExpenseBloc>(
          create: (_) => di.sl<ExpenseBloc>()..add(LoadExpensesEvent()),
        ),
      ],

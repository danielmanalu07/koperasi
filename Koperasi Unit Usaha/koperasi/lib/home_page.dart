...
class _HomePageState extends State<HomePage> {
    ...
    try {
      ...
      if (mounted) {
        if (response.statusCode == 200) {
          ...
          print("data user logging: $responseData");
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      backgroundColor: ColorConstant.abuColor,
      body: SingleChildScrollView(
        child: Column(
          children: <Widget>[
            _buildHeader(context),
            _buildCooperativeInfoSection(context),
            _buildUnitUsaha(context),
    ...
    return Container(
      ...
      decoration: const BoxDecoration(
        gradient: LinearGradient(
          colors: [ColorConstant.blueColor, ColorConstant.blueColor],
  ...
  Widget _buildUnitUsaha(BuildContext context) {
          ...
          child: GridView.count(
            ...
            children: <Widget>[
              ...
              _buildFeatureItem(
                ...
                'Sewa Menyewa',
                onTap: () {
                  context.push('/home/sewa-menyewa');
                },
              ),
              _buildFeatureItem(
                context,
      ...
      child: InkWell(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              Icon(icon, size: 30.0, color: ColorConstant.blackColor),
              const SizedBox(height: 6.0),
              Flexible(
                child: Text(
                  label,

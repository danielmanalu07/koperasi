...
class InitialRoutes {
  ...
  static const String miniMarket = 'mini-market';
  static const String sewaMenyewa = 'sewa-menyewa';

  static const String assetPage = '/asset-page';
  static const String listAssetTransaction = '/asset-page-transaction';
  static const String expansePage = '/expanse-page';
}

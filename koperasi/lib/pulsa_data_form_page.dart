...
class PulsaDataFormPage extends StatefulWidget {
  const PulsaDataFormPage({super.key});

  @override
  State<PulsaDataFormPage> createState() => _PulsaDataFormPageState();
}

class _PulsaDataFormPageState extends State<PulsaDataFormPage> {
  ...
  final List<String> _jenisTransaksiOptions = ['Pulsa', 'Paket Data'];

  // Nominal Pulsa (conditional)
  String? _selectedNominalPulsa;
  final List<String> _nominalPulsaOptions = [
    '10.000',
    '20.000',
    '25.000',
    '50.000',
  ...
  final Map<String, double> _hargaPulsa = { // Placeholder harga
    '10.000': 11500,
    '20.000': 21500,
    '25.000': 26000,
    '50.000': 50500,
  ...
  void _submitForm() {
    if (_formKey.currentState!.validate()) {
      ...
      if (_selectedJenisTransaksi == 'Pulsa') {
        message += 'Nominal Pulsa: $_selectedNominalPulsa\n';
        harga = _hargaPulsa[_selectedNominalPulsa] ?? 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Beli Pulsa & Paket Data'),
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              _buildDropdownFormField(
                ...
                _buildDropdownFormField(
                  value: _selectedNominalPulsa,
                  hintText: 'Pilih Nominal Pulsa',
                  labelText: 'Nominal Pulsa*',
                  icon: Icons.monetization_on_outlined,
                  items: _nominalPulsaOptions,
                  onChanged: (value) {
                    setState(() {
                      _selectedNominalPulsa = value;
                    });
                  },
                  validator: (value) => value == null ? 'Nominal pulsa tidak boleh kosong' : null,
                ),
